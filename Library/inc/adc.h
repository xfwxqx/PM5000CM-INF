...
/**
  ...
  * @note    u32Data should be filled in unsigned format (straight binary format).
  */
...
/**
  ...
  * @return None
  * @note NUC029 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
